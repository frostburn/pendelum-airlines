...
export const demolitionRoutes = [
  ...
  contract({name: 'A sign of progress', gold: 125, silver: 190, sub: 'Please lower expectations before removing them.',
    hint: 'Cut the right hanger first. Keep the marked left hanger intact until the sign has hung down and the lowering task is signed off. Then cut it, swap to the magnet and recover the sign.',
    ...
    goals: [release('right', 'Release the right hanger', ['right-hanger']),
      {id: 'lower', name: 'Lower the sign on its remaining hanger', type: 'rotate', piece: 'sign', angle: -Math.PI / 2, tolerance: .3, after: ['right'], joined: 'left-hanger'},
      {...release('left', 'Cut the remaining hanger', ['left-hanger']), after: ['lower']}, deliver('ship', 'Reclaim the sign', 'sign', 37, .8, 6.4, ['lower', 'left'])]}),
  ...
  contract({name: 'The frame remains', gold: 135, silver: 205, sub: 'The support staff are folding.', width: 47,
    hint: 'Break the high brace to fold the pinned frame sideways. Keep both marked crossbar joints intact until the folded frame settles in its bay and is signed off. Then detach and reclaim the crossbar.',
    ...
    goals: [release('fold', 'Release the frame brace', ['frame-brace']),
      place('lower', 'Fold the crossbar into the right-hand bay', 'crossbar', 24.2, .55, 8, {after: ['fold'], joined: ['left-knee', 'right-knee']}),
      {...release('free', 'Detach the lowered crossbar', ['left-knee', 'right-knee']), after: ['lower']},
