...
<div class="note">Gentle bumps are fine. Hard impacts cost integrity; water or leaving the service area ends the run. Practice mode ignores impact damage. In Metal works, the workpiece can take a beating, but the drone must stay clear of the hammer and press frame. Routes are short, and restarts are unlimited.</div>
<div class="actions">
